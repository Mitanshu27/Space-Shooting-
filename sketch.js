...
function draw() 
{
  ...
  {
    background(0);
    upb.position(100,560);
   leftb.position(30,560);
   rightb.position(150,560);
   fireb.position(1150,30);
   mousep();
   mouser();
  fill(255,255,255);
  rect(10,10,270,120);
